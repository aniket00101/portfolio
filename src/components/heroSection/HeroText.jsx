...
export const HeroText = () => {
    return (
        <div className="flex flex-col gap-4 h-full justify-center md:text-left md:pl-10 sm:text-center">
            ...
            className="lg:text-6xl font-bold sm:text-xl uppercase text-cyan">MERN stack Developer</motion.h2>
            ...
            <motion.p variants={fadeIn('up',0.6)} initial = "hidden" whileInView="show" viewport={{ once: false, amount: 0}} className="text-lg mt-4 text-white">Innovative MERN developer crafting modern, <br/> scalable, and efficient web solutions.</motion.p>
        </div>
    )
}
