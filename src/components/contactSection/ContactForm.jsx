    ...
    <div>
      <p className="text-cyan">{success}</p>
        <form action="" className="flex flex-col gap-4 text-white mt-6" ref={form} onSubmit={sendEmail}>
            ...
            <textarea type="text" name="messages" placeholder="Message" rows='9' cols='50' required className="rounded-lg bg-black/25 border-b-2  p-2 border-orange bg-transparent border-l-2 border-l-orange focus:outline-none backdrop-blur-[10px]" value={messages} onChange={handleMessages}/>
